    ...
    <div class="section margin-top_50">
        <div class="container">
            <div class="row">
				...
				<div class="col-md-6">
                    <div class="full">
                       <div class="card cd-bg">
                           <div class="card-title cd-title">
                           ...
                           <div class="card-body">
                               ...
                               <div class="form-group">
                                 <select class="form-control" name="state">
                                     ...
                                     <option value="">Import export registration</option>
                                     <option value="">Digital signature certificate</option>
                                     <option value="">Fssai registration</option>
                                     <option value="">GST return filling</option>
                                     <option value="">Income tax return</option>
                                 </select>
                               </div>
                               <div class="form-group">
                                   <button class="btn btn-primary" name="submit" type="submit">Request a Call Back</button>
                               </div>
                           </div>
                       </div>
                    </div>
